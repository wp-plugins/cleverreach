...
class haet_cleverreach_admin {
	...
	public function register_settings(){
		...
		add_settings_field( 
				'show_in_comments_optin', 
				__( 'Double Opt-In', 'haet_cleverreach' ), 
				array($this,'field_show_in_comments_optin'), 
				'cleverreach_page_cleverreach-integrations', 
				'integration_comments'
			);
		add_settings_field( 
		...
		// 	);
		// add_settings_field( 
		// 		'show_at_registration_optin', 
		// 		__( 'Double Opt-In', 'haet_cleverreach' ), 
		// 		array($this,'field_show_at_registration_optin'), 
		// 		'cleverreach_page_cleverreach-integrations', 
		// 		'integration_registration'
		// 	);
		// add_settings_field( 
    ...
    public function admin_page_scripts_and_styles($page){
    	//echo $page;
    	if(	$page == 'toplevel_page_cleverreach' 
    		|| $page == 'cleverreach_page_cleverreach-integrations'
    		|| $page == 'cleverreach_page_cleverreach-forms'){
	...
	public function field_show_in_comments_optin(){
		$options = haet_cleverreach_get_settings();?>
		<input name='haet_cleverreach_settings[show_in_comments_optin]' type='radio' value='1' <?php echo ( intval( $options['show_in_comments_optin'] ) == 1?'checked':''); ?> /> <?php _e('Yes'); ?> &nbsp; &nbsp;
		<input name='haet_cleverreach_settings[show_in_comments_optin]' type='radio' value='0' <?php echo ( intval( $options['show_in_comments_optin'] ) != 1?'checked':''); ?> /> <?php _e('No'); ?>
		<?php		
	}
	...
	public function field_show_at_registration_optin(){
		$options = haet_cleverreach_get_settings();?>
		<input name='haet_cleverreach_settings[show_at_registration_optin]' type='radio' value='1' <?php echo ( intval( $options['show_at_registration_optin'] ) == 1?'checked':''); ?> /> <?php _e('Yes'); ?> &nbsp; &nbsp;
		<input name='haet_cleverreach_settings[show_at_registration_optin]' type='radio' value='0' <?php echo ( intval( $options['show_at_registration_optin'] ) != 1?'checked':''); ?> /> <?php _e('No'); ?>
		<?php		
	}
	...
	public function field_signup_optin(){
		$options = haet_cleverreach_get_settings();?>
		<input name='haet_cleverreach_settings[signup_optin]' type='radio' value='1' <?php echo ( intval( $options['signup_optin'] ) == 1?'checked':''); ?> /> <?php _e('Yes'); ?> &nbsp; &nbsp;
		<input name='haet_cleverreach_settings[signup_optin]' type='radio' value='0' <?php echo ( intval( $options['signup_optin'] ) != 1?'checked':''); ?> /> <?php _e('No'); ?>
		<?php		
	}
